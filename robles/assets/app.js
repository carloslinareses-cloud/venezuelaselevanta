(function () {
  ...
  const CONFIG = {
    ...
    // once niveles: el contexto es lo que las hace creíbles.
  ...
  const EN = {
    ...
    "uso.estimacion":
      "<strong>About the €25,000:</strong> the quotes are published below — 2 by engineer Ricardo Girón and 1 by the lift technician, Multiservicios Ávila — together with the Civil Protection report. The three quotes add up to <strong>$14,421</strong>: block wall $1,789.58, elevator counterweight rail $720, and roof slab waterproofing with expansion joints $11,911.56 — in this last one, the joints are quoted <strong>per level</strong> ($763) and the tower has eleven counting the ground floor. Still to be quoted are the <strong>stabilisation works</strong> called for by the Civil Protection report, among them the X-shaped crack in the elevator machine room, which the report describes as \"potentially dangerous, having lost load-bearing capacity\". The goal covers both what is already quoted and those works. If the final figure changes, we will say so on this same page.",
    ...
    "presup.note":
      "These are the documents the figure we are asking for is based on, exactly as they were given to us: three quotes — 2 by engineer Ricardo Girón, for the block wall and for the roof slab waterproofing with expansion joints, and 1 by the lift technician, Multiservicios Ávila, for the counterweight rail — and the Civil Protection technical assessment. The joints are quoted <strong>for each of the tower's eleven levels</strong>. Tap an image to see it in full.",
    "presup.matiz":
    ...
    "updates.u3body":
      "We are publishing the <strong>Civil Protection technical risk report</strong> and <strong>three quotes</strong>: 2 by engineer Ricardo Girón and 1 by the lift technician, Multiservicios Ávila. With the documents in hand, the repair turned out to be more expensive than we had estimated: the expansion joints are quoted for each of the tower's eleven levels, and the stabilisation works called for by the report still have to be costed. That is why we have <strong>raised the goal from €10,000 to €25,000</strong>. The documents are published in full in the \"Quotes and technical assessment\" section.",
    ...
    const hayPresup = agregarFotos(
      ...
      [
        ...
        },
        {
          ...
          alt: "Presupuesto del técnico del ascensor, Multiservicios Ávila, por el riel de contrapeso —",
        },
        {
